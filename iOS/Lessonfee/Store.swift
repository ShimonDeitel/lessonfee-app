...
final class Store: ObservableObject {
    ...
    init() {
        ...
        let dir = appSupport.appendingPathComponent("Lessonfee", isDirectory: true)
    ...
    static func seedData() -> [SessionEntry] {
        ...
        let now = Date()
        return [
            SessionEntry(title: "First visit", vendor: "Instructor A", amount: 24.00, date: cal.date(byAdding: .day, value: -30, to: now) ?? now, notes: ""),
            SessionEntry(title: "Regular visit", vendor: "Instructor B", amount: 32.50, date: cal.date(byAdding: .day, value: -14, to: now) ?? now, notes: ""),
            SessionEntry(title: "Recent visit", vendor: "Instructor A", amount: 18.75, date: cal.date(byAdding: .day, value: -3, to: now) ?? now, notes: ""),
        ]
    }
}
